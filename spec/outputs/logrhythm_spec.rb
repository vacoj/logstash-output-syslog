...
require "logstash/outputs/logrhythm"
require "logstash/codecs/plain"
require "json"

# describe LogStash::Outputs::LogRhythm do
...
#     plugin = LogStash::Plugin.lookup("output", "logrhythm").new({"host" => "foo", "port" => "123", "facility" => "kernel", "severity" => "emergency"})
#     expect { plugin.register }.to_not raise_error
#   end

#   subject do
#     plugin = LogStash::Plugin.lookup("output", "logrhythm").new(options)
#     plugin.register
#     plugin
#   end
...
#   shared_examples "logrhythm output" do
...
#     it_behaves_like "logrhythm output"
#   end
